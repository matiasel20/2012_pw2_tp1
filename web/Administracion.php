...
<div class="principal">
	...
	<div class="center">
			...
			<input type="submit" value="Ingresar foto" />			
			<input type="submit" value="Eliminar foto" />
			<input type="submit" value="Cambiar titulo" />		
			<br/>
		</fieldset>
		
		<fieldset style="margin-bottom:15%">
			<legend>Torneos</legend>
			<input type="submit" value="Ingresar nuevo torneo" />			
			<input type="submit" value="Eliminar torneo" />
		</fieldset>
		...
		<fieldset>
			...
			<input type="submit" value="cancha 1" />
			<input type="submit" value="cancha 2" />
			<input type="submit" value="cancha 3" />			
		</fieldset>
		
		<fieldset style="margin-top:15%">
			<legend>Administracion socios</legend>
			<input type="submit" value="ABM socios" />
			<input type="submit" value="aprobar formularios" />			
		</fieldset>
