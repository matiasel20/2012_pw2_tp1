...
<div class="principal">
	...
	<div class="center">
		<div class="contenido1">
			<table style="font-size:12px ; border: 1px solid white;bordercolor:red ;">
				<tr>
					<th>Nombre </th>
					<th>Apellido</th>
					<th>Localidad</th>
				...
				<tr>
					...
					<td>Rawson</td>
					<td>Juncho34</td>
					<td>Juncho@hotmail.com</td>	<td><input style="font-size:8px" type="submit" value="Eliminar" /></td>
					<td ><input style="font-size:8px"  type="submit" value="Modificar" /></td>		
				</tr>
				<tr>
					<td>Abel</td>
					<td>Pintos</td>
					<td>Madryn</td>
					<td>Lito13</td>
					<td>lito32@gmail.com</td>
					<td><input style="font-size:8px" type="submit" value="Eliminar" /></td>
					<td><input style="font-size:8px" type="submit" value="Modificar" /></td>
				</tr>
				<tr>
					<td>Violencia</td>
